  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 transition-colors shadow-2xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-purple-600 dark:bg-purple-500 text-white flex items-center justify-center font-bold text-lg shadow-sm">
                RM
              </div>
              <div>
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded-lg p-0.5 border border-slate-200 dark:border-slate-700">
              ...
              <span className="px-3 text-xs font-bold text-slate-800 dark:text-slate-200 min-w-[100px] text-center">
            ...
            <div className="hidden sm:block relative flex-1 min-w-[160px] max-w-[220px]">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 text-xs rounded-lg bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
        ...
        <div className={`mt-3 pt-3 border-t border-slate-100 dark:border-slate-800 flex-wrap items-center justify-between gap-2 text-xs ${isActionsExpanded ? 'flex' : 'hidden lg:flex'}`}>
          {/* Quick Actions Left */}
          ...
          <div className="flex flex-wrap items-center gap-2 ml-auto">
            <button
              ...
              disabled={isSyncing}
              className="px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-200 border border-emerald-200 dark:border-emerald-800 font-semibold hover:bg-emerald-100 dark:hover:bg-emerald-900/80 transition-colors flex items-center gap-1.5"
            ...
            <button
              onClick={onSignOut}
              className="p-1.5 rounded-lg text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
              title="Sign Out"
            >
